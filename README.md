...
So, after changing Docker Image and some transformation in the code, I got this size:
![Comparison](https://github.com/kseniakoshkina/infrastructure/blob/dependencies/change.png)
